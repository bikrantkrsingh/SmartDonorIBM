...
public final class BlueListApplication extends Application {
	...
	public void onCreate() {
		super.onCreate();
		itemList = new ArrayList<Registration>();
...
//		IBMBaaS.initializeSDK(this, props.getProperty(APP_ID));
		...
		Registration.registerSpecialization(Registration.class);
		Transaction.registerSpecialization(Transaction.class);
	}
	 ...
	 * @return itemList
	 */
	public List<Registration> getItemList() {
		return itemList;
	}
